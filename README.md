# Проект Pythia Parser West Virginia
...
После установки всех зависимостей и настройки переменных окружения, запускаем скрипт `Pythia_parser_WV.py`:

```bash
python Pythia_parser_WV.py
```
